    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "BASE_URL = \"http://127.0.0.1:8523\"\n",
                "\n",
                "# Authorization tokens (operator vs approver identity)\n",
                ...
                "\n",
                "print(f\"Connected to API Target: {BASE_URL}\")"
            ]
        },
        {
            "cell_type": "markdown",
...
out_file = Path("notebooks/02_api_platform_testing.ipynb")
out_file.parent.mkdir(parents=True, exist_ok=True)
out_file.write_text(json.dumps(notebook, indent=1))
print("Created notebooks/02_api_platform_testing.ipynb successfully.")
